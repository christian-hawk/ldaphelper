...
class TrustRelationships:
    ...
    def create_tr(
        ...
        gluuEntityId: str,
        description: str,
        gluuReleasedAttribute: list,
        gluuProfileConfiguration: list,
        gluuSAMLspMetaDataFN: str,
        metadata: str,
        gluuSAMLspMetaDataSourceType: str = "file",
        gluuSpecificRelyingPartyConfig: bool = True,
        gluuStatus: str = "active",
        gluuSAMLmaxRefreshDelay="PT8H",
        gluuIsFederation: bool = False,
    ):
        ...
        attrs[
            "gluuSpecificRelyingPartyConfig"] = gluuSpecificRelyingPartyConfig
    ...
    def __upload_metadata(self, file_name: str, metadata: str):
        ...
        subprocess.run(
            [
                "scp",
                file_name,
                "eland.christian@chris.gluutwo.org:/opt/gluu-server/opt/shibboleth-idp/metadata",
            ],
            check=True,
        )
