...
class Passport:
    def __init__(self, login, password):
        ...
        self.gluuPassportConfiguration = self.oxpassport[
    ...
    def getOxPassport(self) -> dict:
        ...
        oxpassport = self.connection.connect.search_s(
            self.connection.baseDN, self.connection.searchScope,
            "ou=oxpassport")[0][1]
        return oxpassport
    ...
    def add_provider(
        ...
        provider_type: str,
        mapping: str,
        passportStrategyId: str,
        enabled: bool,
        callbackUrl: str,
        requestForEmail: bool,
        emailLinkingSafe: bool,
        options: dict,
    ):
